    ...
    return (
        <div className="page-content">
            ...
            <div className="topics-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '2rem', marginTop: '2rem' }}>
                <Link to="/topics/data" className="topic-card" style={{
                    display: 'block',
                    padding: '2rem',
                    ...
                    <h2 style={{ color: '#00509e', marginBottom: '1rem' }}>Dados</h2>
                    <p style={{ color: '#666' }}>Aprenda sobre os tipos básicos de dados: Números, Strings e Booleanos.</p>
                </Link>
