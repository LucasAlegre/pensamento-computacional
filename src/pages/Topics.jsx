    ...
    return (
        <div className="page-content">
            ...
            <div className="topics-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '2rem', marginTop: '2rem' }}>
                ...
                <Link to="/topics/learning" className="topic-card" style={{
                    display: 'block',
                    padding: '2rem',
                    ...
                    <h2 style={{ color: '#00509e', marginBottom: '1rem' }}>Aprendendo a Programar</h2>
                    <p style={{ color: '#666' }}>Dicas e diretrizes sobre como aprender a programar e estudar para a disciplina.</p>
                </Link>
                ...
                <Link to="/topics/tipos-de-dados" className="topic-card" style={{
                    display: 'block',
                    padding: '2rem',
                    backgroundColor: 'white',
                    borderRadius: '8px',
                    ...
                    <h2 style={{ color: '#00509e', marginBottom: '1rem' }}>Tipos de Dados</h2>
                    <p style={{ color: '#666' }}>Aprenda sobre os principais tipos de dados em Pyret.</p>
                </Link>
